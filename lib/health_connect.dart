...
class iHealthDevicesManager extends jni.JObject {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  Hs2sControl getHs2sControl(
    jni.JString string,
  ) {
    return const $Hs2sControlType()
...
/// from: com.ihealth.communication.control.Hs2sControl
class Hs2sControl extends jni.JObject {
  @override
  late final jni.JObjType<Hs2sControl> $type = type;
  ...
  /// The type which includes information such as the signature of this class.
  static const type = $Hs2sControlType();
  static final _new0 = jniLookup<
          ffi.NativeFunction<
              jni.JniResult Function(
                  ffi.Pointer<ffi.Void>,
                  ...
                  ffi.Pointer<ffi.Void>,
                  ffi.Pointer<ffi.Void>,
                  ffi.Pointer<ffi.Void>)>>("Hs2sControl__new0")
      .asFunction<
          jni.JniResult Function(
              ffi.Pointer<ffi.Void>,
              ffi.Pointer<ffi.Void>,
  ...
  /// from: public void <init>(android.content.Context context, com.ihealth.communication.base.comm.BaseComm baseComm, java.lang.String string, java.lang.String string1, java.lang.String string2, com.ihealth.communication.ins.InsCallback insCallback, com.ihealth.communication.base.comm.BaseCommCallback baseCommCallback)
  /// The returned object must be released after use, by calling the [release] method.
  factory Hs2sControl(
    Context context,
    jni.JObject baseComm,
    jni.JString string,
    jni.JString string1,
    jni.JString string2,
    jni.JObject insCallback,
    jni.JObject baseCommCallback,
  ) {
    return Hs2sControl.fromRef(_new0(
            context.reference,
            baseComm.reference,
            string.reference,
            string1.reference,
            string2.reference,
            insCallback.reference,
            baseCommCallback.reference)
        .object);
  }

  static final _getDeviceInfo = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__getDeviceInfo")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void getDeviceInfo()
  void getDeviceInfo() {
    return _getDeviceInfo(reference).check();
  }

  static final _getBattery = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__getBattery")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void getBattery()
  void getBattery() {
    return _getBattery(reference).check();
  }

  static final _setUnit = jniLookup<
          ffi.NativeFunction<
              jni.JniResult Function(
                  ffi.Pointer<ffi.Void>, ffi.Int32)>>("Hs2sControl__setUnit")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>, int)>();

  /// from: public void setUnit(int i)
  void setUnit(
    int i,
  ) {
    return _setUnit(reference, i).check();
  }

  static final _getUserInfo = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__getUserInfo")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void getUserInfo()
  void getUserInfo() {
    return _getUserInfo(reference).check();
  }

  static final _createOrUpdateUserInfo = jniLookup<
          ffi.NativeFunction<
              jni.JniResult Function(
                  ffi.Pointer<ffi.Void>,
                  ffi.Pointer<ffi.Void>,
                  ...
                  ffi.Int32,
                  ffi.Int32,
                  ffi.Int32)>>("Hs2sControl__createOrUpdateUserInfo")
      .asFunction<
          jni.JniResult Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
              double, int, int, int, int, int)>();

  /// from: public void createOrUpdateUserInfo(java.lang.String string, float f, int i, int i1, int i2, int i3, int i4)
  void createOrUpdateUserInfo(
    jni.JString string,
    double f,
    int i,
    int i1,
    ...
    return _createOrUpdateUserInfo(
            reference, string.reference, f, i, i1, i2, i3, i4)
        .check();
  }

  static final _deleteUserInfo = jniLookup<
          ffi.NativeFunction<
              jni.JniResult Function(ffi.Pointer<ffi.Void>,
                  ffi.Pointer<ffi.Void>)>>("Hs2sControl__deleteUserInfo")
      .asFunction<
          jni.JniResult Function(
              ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>();

  /// from: public void deleteUserInfo(java.lang.String string)
  void deleteUserInfo(
    jni.JString string,
  ) {
    return _deleteUserInfo(reference, string.reference).check();
  }

  static final _specifyTouristUsers = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__specifyTouristUsers")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void specifyTouristUsers()
  void specifyTouristUsers() {
    return _specifyTouristUsers(reference).check();
  }

  static final _specifyOnlineUsers = jniLookup<
          ffi.NativeFunction<
              jni.JniResult Function(
                  ffi.Pointer<ffi.Void>,
                  ffi.Pointer<ffi.Void>,
                  ...
                  ffi.Int32,
                  ffi.Int32,
                  ffi.Int32)>>("Hs2sControl__specifyOnlineUsers")
      .asFunction<
          jni.JniResult Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
              double, int, int, int, int, int)>();

  /// from: public void specifyOnlineUsers(java.lang.String string, float f, int i, int i1, int i2, int i3, int i4)
  void specifyOnlineUsers(
    jni.JString string,
    double f,
    int i,
    int i1,
    ...
    return _specifyOnlineUsers(
            reference, string.reference, f, i, i1, i2, i3, i4)
        .check();
  }

  static final _getOfflineDataCount = jniLookup<
          ffi.NativeFunction<
              jni.JniResult Function(ffi.Pointer<ffi.Void>,
                  ffi.Pointer<ffi.Void>)>>("Hs2sControl__getOfflineDataCount")
      .asFunction<
          jni.JniResult Function(
              ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>();

  /// from: public void getOfflineDataCount(java.lang.String[] strings)
  void getOfflineDataCount(
    jni.JArray<jni.JString> strings,
  ) {
    return _getOfflineDataCount(reference, strings.reference).check();
  }

  static final _getOfflineData = jniLookup<
          ffi.NativeFunction<
              jni.JniResult Function(ffi.Pointer<ffi.Void>,
                  ffi.Pointer<ffi.Void>)>>("Hs2sControl__getOfflineData")
      .asFunction<
          jni.JniResult Function(
              ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>();

  /// from: public void getOfflineData(java.lang.String string)
  void getOfflineData(
    jni.JString string,
  ) {
    return _getOfflineData(reference, string.reference).check();
  }

  static final _deleteOfflineData = jniLookup<
          ffi.NativeFunction<
              jni.JniResult Function(ffi.Pointer<ffi.Void>,
                  ffi.Pointer<ffi.Void>)>>("Hs2sControl__deleteOfflineData")
      .asFunction<
          jni.JniResult Function(
              ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>();

  /// from: public void deleteOfflineData(java.lang.String string)
  void deleteOfflineData(
    jni.JString string,
  ) {
    return _deleteOfflineData(reference, string.reference).check();
  }

  static final _getAnonymousDataCount = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__getAnonymousDataCount")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void getAnonymousDataCount()
  void getAnonymousDataCount() {
    return _getAnonymousDataCount(reference).check();
  }

  static final _getAnonymousData = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__getAnonymousData")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void getAnonymousData()
  void getAnonymousData() {
    return _getAnonymousData(reference).check();
  }

  static final _deleteAnonymousData = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__deleteAnonymousData")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void deleteAnonymousData()
  void deleteAnonymousData() {
    return _deleteAnonymousData(reference).check();
  }

  static final _startHeartRateMode = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__startHeartRateMode")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void startHeartRateMode()
  void startHeartRateMode() {
    return _startHeartRateMode(reference).check();
  }

  static final _stopHeartRateMode = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__stopHeartRateMode")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void stopHeartRateMode()
  void stopHeartRateMode() {
    return _stopHeartRateMode(reference).check();
  }

  static final _setBleLight = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__setBleLight")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void setBleLight()
  void setBleLight() {
    return _setBleLight(reference).check();
  }

  static final _restoreFactorySettings = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__restoreFactorySettings")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public void restoreFactorySettings()
  void restoreFactorySettings() {
    return _restoreFactorySettings(reference).check();
  }

  static final _getUpDeviceControl = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__getUpDeviceControl")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public com.ihealth.communication.control.UpDeviceControl getUpDeviceControl()
  /// The returned object must be released after use, by calling the [release] method.
  jni.JObject getUpDeviceControl() {
    return const jni.JObjectType()
        .fromRef(_getUpDeviceControl(reference).object);
  }
  ...
  static final _getIDPS = jniLookup<
              ffi
              .NativeFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>>(
          "Hs2sControl__getIDPS")
      .asFunction<jni.JniResult Function(ffi.Pointer<ffi.Void>)>();

  /// from: public java.lang.String getIDPS()
  /// The returned object must be released after use, by calling the [release] method.
  jni.JString getIDPS() {
    return const jni.JStringType().fromRef(_getIDPS(reference).object);
  }
}

final class $Hs2sControlType extends jni.JObjType<Hs2sControl> {
  const $Hs2sControlType();

  @override
  String get signature => r"Lcom/ihealth/communication/control/Hs2sControl;";

  @override
  Hs2sControl fromRef(jni.JObjectPtr ref) => Hs2sControl.fromRef(ref);
  ...
  @override
  int get hashCode => ($Hs2sControlType).hashCode;

  @override
  bool operator ==(Object other) {
    return other.runtimeType == ($Hs2sControlType) && other is $Hs2sControlType;
  }
}

/// from: com.ihealth.communication.control.Hs2sProfile
class Hs2sProfile extends jni.JObject {
  @override
  late final jni.JObjType<Hs2sProfile> $type = type;
  ...
  /// The type which includes information such as the signature of this class.
  static const type = $Hs2sProfileType();

  /// from: static public final java.lang.String ACTION_ERROR_HS
  static const ACTION_ERROR_HS = r"""action_error""";

  /// from: static public final java.lang.String ERROR_NUM_HS
  static const ERROR_NUM_HS = r"""error_num""";

  /// from: static public final java.lang.String ERROR_DESCRIPTION_HS
  static const ERROR_DESCRIPTION_HS = r"""error_description""";

  /// from: static public final java.lang.String ACTION_GET_DEVICE_INFO
  static const ACTION_GET_DEVICE_INFO = r"""action_get_device_info""";

  /// from: static public final java.lang.String HS_USER_COUNT
  static const HS_USER_COUNT = r"""user_count""";

  /// from: static public final java.lang.String HS_UNIT_CURRENT
  static const HS_UNIT_CURRENT = r"""unit_current""";

  /// from: static public final java.lang.String ACTION_BATTERY_HS
  static const ACTION_BATTERY_HS = r"""battery_hs""";

  /// from: static public final java.lang.String BATTERY_HS
  static const BATTERY_HS = r"""battery""";

  /// from: static public final java.lang.String ACTION_SET_UNIT_SUCCESS
  static const ACTION_SET_UNIT_SUCCESS = r"""action_set_unit_success""";

  /// from: static public final java.lang.String ACTION_SET_BROADCAST
  static const ACTION_SET_BROADCAST = r"""action_set_broadcast""";

  /// from: static public final java.lang.String ACTION_SET_BLE_LIGHT
  static const ACTION_SET_BLE_LIGHT = r"""action_set_ble_light""";

  /// from: static public final int UNIT_KG
  static const UNIT_KG = 1;

  /// from: static public final int UNIT_LB
  static const UNIT_LB = 2;

  /// from: static public final int UNIT_ST
  static const UNIT_ST = 3;

  /// from: static public final int POWER_SAVE_MODE_CLOSE
  static const POWER_SAVE_MODE_CLOSE = 0;

  /// from: static public final int POWER_SAVE_MODE_SLOW_BROADCAST
  static const POWER_SAVE_MODE_SLOW_BROADCAST = 1;

  /// from: static public final int POWER_SAVE_MODE_SLOW_BROADCAST_SUPER
  static const POWER_SAVE_MODE_SLOW_BROADCAST_SUPER = 2;

  /// from: static public final java.lang.String ACTION_GET_USER_INFO
  static const ACTION_GET_USER_INFO = r"""action_get_user_info""";

  /// from: static public final java.lang.String USER_INFO_COUNT
  static const USER_INFO_COUNT = r"""user_info_count""";

  /// from: static public final java.lang.String USER_INFO_ARRAY
  static const USER_INFO_ARRAY = r"""user_info_array""";

  /// from: static public final java.lang.String USER_INFO_USER_ID
  static const USER_INFO_USER_ID = r"""user_id""";

  /// from: static public final java.lang.String USER_INFO_CREATE_TIME
  static const USER_INFO_CREATE_TIME = r"""create_time""";

  /// from: static public final java.lang.String USER_INFO_WEIGHT
  static const USER_INFO_WEIGHT = r"""weight""";

  /// from: static public final java.lang.String USER_INFO_GENDER
  static const USER_INFO_GENDER = r"""gender""";

  /// from: static public final java.lang.String USER_INFO_AGE
  static const USER_INFO_AGE = r"""age""";

  /// from: static public final java.lang.String USER_INFO_HEIGHT
  static const USER_INFO_HEIGHT = r"""height""";

  /// from: static public final java.lang.String USER_INFO_IMPEDANCE
  static const USER_INFO_IMPEDANCE = r"""impedance""";

  /// from: static public final java.lang.String USER_INFO_BODYBUILDING
  static const USER_INFO_BODYBUILDING = r"""body_building""";

  /// from: static public final java.lang.String USER_INFO_BODY_FORM
  static const USER_INFO_BODY_FORM = r"""body_form""";

  /// from: static public final java.lang.String ACTION_CREATE_OR_UPDATE_USER_INFO
  static const ACTION_CREATE_OR_UPDATE_USER_INFO =
      r"""action_create_or_update_user_info""";

  /// from: static public final java.lang.String OPERATION_STATUS
  static const OPERATION_STATUS = r"""status""";

  /// from: static public final java.lang.String OPERATION_DESCRIBE
  static const OPERATION_DESCRIBE = r"""describe""";

  /// from: static public final java.lang.String ACTION_DELETE_USER_INFO
  static const ACTION_DELETE_USER_INFO = r"""action_delete_user_info""";

  /// from: static public final java.lang.String ACTION_SPECIFY_USERS
  static const ACTION_SPECIFY_USERS = r"""action_specify_users""";

  /// from: static public final java.lang.String ACTION_MEASURE_FINISH_AT_CRITICAL
  static const ACTION_MEASURE_FINISH_AT_CRITICAL =
      r"""action_measure_finish_at_critical""";

  /// from: static public final java.lang.String ACTION_HISTORY_DATA_NUM
  static const ACTION_HISTORY_DATA_NUM = r"""action_history_data_num""";

  /// from: static public final java.lang.String HISTORY_DATA_USER_COUNT
  static const HISTORY_DATA_USER_COUNT = r"""history_data_user_count""";

  /// from: static public final java.lang.String HISTORY_DATA_COUNT_ARRAY
  static const HISTORY_DATA_COUNT_ARRAY = r"""history_data_count_array""";

  /// from: static public final java.lang.String HISTORY_DATA_COUNT
  static const HISTORY_DATA_COUNT = r"""history_data_count""";

  /// from: static public final java.lang.String ACTION_HISTORY_DATA
  static const ACTION_HISTORY_DATA = r"""action_history_data""";

  /// from: static public final java.lang.String DATA_ID
  static const DATA_ID = r"""dataID""";

  /// from: static public final java.lang.String DATA_WEIGHT
  static const DATA_WEIGHT = r"""weight""";

  /// from: static public final java.lang.String DATA_IMPEDANCE
  static const DATA_IMPEDANCE = r"""impedance""";

  /// from: static public final java.lang.String DATA_IMPEDANCE_ENCRYPT
  static const DATA_IMPEDANCE_ENCRYPT = r"""impedanceEncrypt""";

  /// from: static public final java.lang.String DATA_USER_NUM
  static const DATA_USER_NUM = r"""user_num""";

  /// from: static public final java.lang.String DATA_GENDER
  static const DATA_GENDER = r"""gender""";

  /// from: static public final java.lang.String DATA_AGE
  static const DATA_AGE = r"""age""";

  /// from: static public final java.lang.String DATA_HEIGHT
  static const DATA_HEIGHT = r"""height""";

  /// from: static public final java.lang.String DATA_MEASURE_TIME
  static const DATA_MEASURE_TIME = r"""measure_time""";

  /// from: static public final java.lang.String DATA_RIGHT_TIME
  static const DATA_RIGHT_TIME = r"""right_time""";

  /// from: static public final java.lang.String DATA_BODYBUILDING
  static const DATA_BODYBUILDING = r"""body_building""";

  /// from: static public final java.lang.String DATA_INSTRUCTION_TYPE
  static const DATA_INSTRUCTION_TYPE = r"""instruction_type""";

  /// from: static public final java.lang.String DATA_IMPEDANCE_ERRORS
  static const DATA_IMPEDANCE_ERRORS = r"""data_impedance_errors""";

  /// from: static public final java.lang.String DATA_BODY_FIT_PERCENTAGE
  static const DATA_BODY_FIT_PERCENTAGE = r"""body_fit_percentage""";

  /// from: static public final java.lang.String DATA_MUSCLE_MASS
  static const DATA_MUSCLE_MASS = r"""muscle_mas""";

  /// from: static public final java.lang.String DATA_BONE_SALT_CONTENT
  static const DATA_BONE_SALT_CONTENT = r"""bone_salt_content""";

  /// from: static public final java.lang.String DATA_BODY_WATER_RATE
  static const DATA_BODY_WATER_RATE = r"""body_water_rate""";

  /// from: static public final java.lang.String DATA_PROTEIN_RATE
  static const DATA_PROTEIN_RATE = r"""protein_rate""";

  /// from: static public final java.lang.String DATA_SKELETAL_MUSCLE_MASS
  static const DATA_SKELETAL_MUSCLE_MASS = r"""skeletal_muscle_mass""";

  /// from: static public final java.lang.String DATA_BASAL_METABOLIC_RATE
  static const DATA_BASAL_METABOLIC_RATE = r"""basal_metabolic_rate""";

  /// from: static public final java.lang.String DATA_VISCERAL_FAT_GRADE
  static const DATA_VISCERAL_FAT_GRADE = r"""visceral_fat_grade""";

  /// from: static public final java.lang.String DATA_PHYSICAL_AGE
  static const DATA_PHYSICAL_AGE = r"""physical_age""";

  /// from: static public final java.lang.String DATA_BODY_MASS_INDEX
  static const DATA_BODY_MASS_INDEX = r"""body_mass_index""";

  /// from: static public final java.lang.String DATA_STANDARD_WEIGHT
  static const DATA_STANDARD_WEIGHT = r"""standard_weight""";

  /// from: static public final java.lang.String DATA_WEIGHT_CONTROL
  static const DATA_WEIGHT_CONTROL = r"""weight_control""";

  /// from: static public final java.lang.String DATA_MUSCLE_CONTROL
  static const DATA_MUSCLE_CONTROL = r"""muscle_control""";

  /// from: static public final java.lang.String DATA_FAT_CONTROL
  static const DATA_FAT_CONTROL = r"""fat_control""";

  /// from: static public final java.lang.String DATA_FAT_WEIGHT
  static const DATA_FAT_WEIGHT = r"""fat_weight""";

  /// from: static public final java.lang.String DATA_DE_FAT_WEIGHT
  static const DATA_DE_FAT_WEIGHT = r"""de_fat_weight""";

  /// from: static public final java.lang.String DATA_HEARTRATE
  static const DATA_HEARTRATE = r"""heartrate""";

  /// from: static public final java.lang.String DATA_PACKAGE_ID
  static const DATA_PACKAGE_ID = r"""package_id""";

  /// from: static public final java.lang.String DATA_HEARTRATE_POINTS
  static const DATA_HEARTRATE_POINTS = r"""heartrate_points""";

  /// from: static public final java.lang.String ACTION_ONLINE_RESULT
  static const ACTION_ONLINE_RESULT = r"""action_online_result""";

  /// from: static public final java.lang.String ACTION_DELETE_HISTORY_DATA
  static const ACTION_DELETE_HISTORY_DATA = r"""action_delete_history_data""";

  /// from: static public final java.lang.String ACTION_ANONYMOUS_DATA_NUM
  static const ACTION_ANONYMOUS_DATA_NUM = r"""action_anonymous_data_num""";

  /// from: static public final java.lang.String ANONYMOUS_DATA_COUNT
  static const ANONYMOUS_DATA_COUNT = r"""anonymous_data_count""";

  /// from: static public final java.lang.String ACTION_ANONYMOUS_DATA
  static const ACTION_ANONYMOUS_DATA = r"""action_anonymous_data""";

  /// from: static public final java.lang.String ACTION_DELETE_ANONYMOUS_DATA
  static const ACTION_DELETE_ANONYMOUS_DATA =
      r"""action_delete_anonymous_data""";

  /// from: static public final java.lang.String ACTION_ONLINE_REAL_TIME_WEIGHT
  static const ACTION_ONLINE_REAL_TIME_WEIGHT =
      r"""action_online_real_time_weight""";

  /// from: static public final java.lang.String ACTION_BODY_FAT_RESULT
  static const ACTION_BODY_FAT_RESULT = r"""action_body_fat_result""";

  /// from: static public final java.lang.String DATA_BODY_FAT_RESULT
  static const DATA_BODY_FAT_RESULT = r"""data_body_fat_result""";

  /// from: static public final java.lang.String ACTION_RESTORE_FACTORY_SETTINGS
  static const ACTION_RESTORE_FACTORY_SETTINGS =
      r"""action_restore_factory_settings""";

  /// from: static public final java.lang.String ACTION_START_HEARTRATE_MEASURE
  static const ACTION_START_HEARTRATE_MEASURE =
      r"""action_start_heartrate_measure""";

  /// from: static public final java.lang.String ACTION_STOP_HEARTRATE_MEASURE
  static const ACTION_STOP_HEARTRATE_MEASURE =
      r"""action_stop_heartrate_measure""";

  /// from: static public final java.lang.String ACTION_HEARTRATE_MEASURE_STATUS
  static const ACTION_HEARTRATE_MEASURE_STATUS =
      r"""action_heartrate_measure_status""";

  /// from: static public final java.lang.String ACTION_HEARTRATE_REALTIME_MEASURE
  static const ACTION_HEARTRATE_REALTIME_MEASURE =
      r"""action_heartrate_realtime_measure""";

  /// from: static public final java.lang.String ACTION_HEARTRATE_RESULT
  static const ACTION_HEARTRATE_RESULT = r"""action_stop_heartrate_result""";

  /// from: static public final java.lang.String HEART_RATE_RESULT
  static const HEART_RATE_RESULT = r"""heart_rate_result""";

  /// from: static public final java.lang.String HEART_RATE_MEASURE_TIME
  static const HEART_RATE_MEASURE_TIME = r"""heart_rate_measure_time""";

  /// from: static public final java.lang.String HEART_RATE_PACKAGE_INDEX
  static const HEART_RATE_PACKAGE_INDEX = r"""heart_rate_package_index""";

  /// from: static public final java.lang.String HEART_RATE_PACKAGE_DATA
  static const HEART_RATE_PACKAGE_DATA = r"""heart_rate_package_data""";

  /// Maps a specific port to the implemented interface.
  static final Map<int, $Hs2sProfileImpl> _$impls = {};
  ReceivePort? _$p;
  ...
  factory Hs2sProfile.implement(
    $Hs2sProfileImpl $impl,
  ) {
    final $p = ReceivePort();
    final $x = Hs2sProfile.fromRef(
      ProtectedJniExtensions.newPortProxy(
        r"com.ihealth.communication.control.Hs2sProfile",
        $p,
        _$invokePointer,
      ),
    ).._$p = $p;
...
abstract class $Hs2sProfileImpl {
  factory $Hs2sProfileImpl() = _$Hs2sProfileImpl;
}

class _$Hs2sProfileImpl implements $Hs2sProfileImpl {
  _$Hs2sProfileImpl();
}

final class $Hs2sProfileType extends jni.JObjType<Hs2sProfile> {
  const $Hs2sProfileType();

  @override
  String get signature => r"Lcom/ihealth/communication/control/Hs2sProfile;";

  @override
  Hs2sProfile fromRef(jni.JObjectPtr ref) => Hs2sProfile.fromRef(ref);
  ...
  @override
  int get hashCode => ($Hs2sProfileType).hashCode;

  @override
  bool operator ==(Object other) {
    return other.runtimeType == ($Hs2sProfileType) && other is $Hs2sProfileType;
  }
}
